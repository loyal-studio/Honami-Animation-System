    ...
    public sealed class IKAndConstraintsPage : IHonamiDocumentationPage
    {
        ...
        public void BuildContent(VisualElement root)
        {
            ...
            HonamiDocumentationBuilder.AddTable(root,
                ...
                ("Pseudo-Physics", HonamiDocLocalization.Get("Springy secondary motion, or a simulated hanging chain.", "Spring secondary motion або симульований підвішений ланцюг."), HonamiDocLocalization.Get("Hair, tails, cloth strips, weapon sway, soft armor — or keychains and pendants that must hang and swing.", "Hair, tails, cloth strips, weapon sway, soft armor — або брелки та підвіски, що мають звисати й гойдатися."))
            );
            ...
            HonamiDocumentationBuilder.AddBulletPoint(root, HonamiDocLocalization.Get("Pseudo-Physics, PseudoPhysics mode: add follow-through to hair, tails, cloth strips, antennae, cables or soft armor.", "Pseudo-Physics, режим PseudoPhysics: додавайте follow-through для hair, tails, cloth strips, antennae, cables або soft armor."));
            HonamiDocumentationBuilder.AddBulletPoint(root, HonamiDocLocalization.Get("Pseudo-Physics, Simulation mode: let a keychain, pendant or strap hang under gravity and swing with the weapon.", "Pseudo-Physics, режим Simulation: дозвольте брелку, підвісці чи ремінцю звисати під gravity й гойдатися разом зі зброєю."));
